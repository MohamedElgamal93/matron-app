...
class MapPageState extends State<MapPage> {
  ...
  String googleAPIKey = "AIzaSyBPkaNi977BHu3tO2ALRt0flAlFhIV55Vg";
  BitmapDescriptor? sourceIcon;
  BitmapDescriptor? destinationIcon;
  List<TaskModel> listofTasks =  <TaskModel>[];
  ...
  void setSourceAndDestinationIcons() async {
    sourceIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 2.5), 'assets/images/splash/source.png');
    destinationIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 2.5), 'assets/images/splash/destination.png');
  }
      ...
      for (var one in listofTasks) {
        try {
          ...
          (await polylinePoints.getRouteBetweenCoordinates(googleAPIKey,
              one.slatitude, one.slongitude,)) as List<PointLatLng>;
